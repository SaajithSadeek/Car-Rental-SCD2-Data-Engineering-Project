    ...
    sql="""
        ...
        USING (
            SELECT
                ...
                $3 AS email,
                $4 AS phone
            FROM @customer_data_stage/customers_{{ ti.xcom_pull(task_ids='get_execution_date') }}.csv (FILE_FORMAT => 'csv_format')
        ) AS source
...
CLUSTER_NAME = 'cluster-8c4c'
PROJECT_ID = 'lateral-yew-445116-f8'
REGION = 'us-central1'

pyspark_job_file_path = 'gs://snowflake_project_test/spark_job/spark_job.py'
...
submit_pyspark_job = DataprocSubmitPySparkJobOperator(
    ...
    dag=dag,
    dataproc_jars=['gs://snowflake_project_test/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar', 'gs://snowflake_project_test/snowflake_jars/snowflake-jdbc-3.16.0.jar']
)
