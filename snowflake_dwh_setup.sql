...
STORAGE_ALLOWED_LOCATIONS = ('gcs://snowflake_project_test/car_rental_data/car_rental_daily_data/')
ENABLED = TRUE;

DESC INTEGRATION gcs_car_rental_integration;

CREATE OR REPLACE STAGE car_rental_data_stage
URL = 'gcs://snowflake_project_test/car_rental_data/car_rental_daily_data/'
STORAGE_INTEGRATION = gcs_car_rental_integration
FILE_FORMAT = (TYPE = CSV FIELD_OPTIONALLY_ENCLOSED_BY = '"');

CREATE STORAGE INTEGRATION gcs_customer_integration
TYPE = EXTERNAL_STAGE
STORAGE_PROVIDER = GCS
STORAGE_ALLOWED_LOCATIONS = ('gcs://snowflake_project_test/car_rental_data/customer_daily_data/')
ENABLED = TRUE;

DESC INTEGRATION gcs_customer_integration;   
                                         
CREATE OR REPLACE STAGE customer_data_stage
URL = 'gcs://snowflake_project_test/car_rental_data/customer_daily_data/'
STORAGE_INTEGRATION = gcs_customer_integration
FILE_FORMAT = (TYPE = CSV FIELD_OPTIONALLY_ENCLOSED_BY = '"');
