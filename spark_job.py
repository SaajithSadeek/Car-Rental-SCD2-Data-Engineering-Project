...
def process_car_rental_data(data_date):
    ...
    spark = SparkSession.builder \
        ...
        .config("spark.jars", "gs://snowflake_project_test/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar,gs://snowflake_project_test/snowflake_jars/snowflake-jdbc-3.16.0.jar") \
        .getOrCreate()


    # Define GCS file path based on the date argument
    gcs_file_path = f"gs://snowflake_project_test/car_rental_data/car_rental_daily_data/car_rental_{data_date}.json"
    ...
    snowflake_options = {
        "sfURL": "https://cqpwslb-sw98437.snowflakecomputing.com",
        "sfAccount": "cqpwslb-sw98437",
        "sfUser": "inham",
        "sfPassword": "Lw7F6XhJfW4y7GU",
